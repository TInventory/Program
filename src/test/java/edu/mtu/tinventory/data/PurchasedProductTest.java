...
public class PurchasedProductTest {
	...
	public void testDisplayPrices() {
		...
		assertEquals(test.getDisplayUnitPrice(), "122.2");
		assertEquals(test.getDisplayTotalPrice(), "1466.4");
	}
	@Test
	public void testGets() {
		...
		assertEquals(test.getTotalPrice(), 1466.4);
		assertEquals(test.getUnitPrice(), 122.2);
	}
}
